...
//document.addEventListener('deviceready', function() { 
	...
	//public variables
	$.client 					= {};
	$.client.cdn 				= ''; //ex. http://server.client.com
	$.client.server 			= ''; //ex. http://cdn.client.com
	...
	$.client.chops
		...
		.on('client-request', function(e, state) {
			...
			switch(true) {
				default:
					//show the loader
					$.mobility.swap('Welcome to Mobility\'s Boilerplate');
					break;
			}
		})
		...
		.on('mobility-paginate', function(e, target, callback) {
			//all list pagination events pass through here
			//if using pagination component call the "callback" passing HTML
		})
		
		//when a list scrolls to the top
		//we can add additional content
		.on('mobility-refresh', function(e, target, callback) {
			//all list refresh events pass through here
			//if using refresh component call the "callback" passing HTML
		})
